...
package {
	public class MultipleCatchBlocksWithURICaughtByErrorTest extends BaseTest {
			...
			try { 
			     throw new URIError();
			      ...
			      thisError = e10.toString();
			        ...
			        AddTestCase( "Testing try block with throw statement", "Error: URIError"        ,Error(thisError)+"" );
			     }
