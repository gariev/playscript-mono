...
package {
	public class NestedTryWithMultipleCatchInsideSecondCatchTest extends BaseTest {
		public static function Main():int {
			...
			try{
			   throw new TypeError();
			       ...
			       //print(thisError1);
			        try { 
			             throw new TypeError();
			                 ...
			                 AddTestCase( "Testing Nested try block with multiple catch block inside the second catch block of the outer try block","This is inner finally:This is Inner Type Error:TypeError","This is inner finally:"+thisError );
			              }
			       ...
			       AddTestCase( "Testing Nested try block with multiple catch block inside the second catch block of the outer try block", "This is outer finally:This is outer TypeError:TypeError","This is outer finally:"+ thisError1 );
			    }
