...
package {
	public class NestedTryWithMulitpleCatchInsideEighthCatchTest extends BaseTest {
		public static function Main():int {
			var SECTION = "Definitions";           // provide a document reference (ie, ECMA section)
			var VERSION = "AS3";                   // Version of JavaScript or ECMA
			var TITLE   = "Testing try block with multiple catch blocks, the eighth catch block catching the type error";  // Provide ECMA section title or a description
			var BUGNUMBER = "";
