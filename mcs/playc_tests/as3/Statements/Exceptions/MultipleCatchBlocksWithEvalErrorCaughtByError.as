...
package {
	public class MultipleCatchBlocksWithEvalErrorCaughtByErrorTest extends BaseTest {
		public static function Main():int {
			var SECTION:* = "Definitions";           // provide a document reference (ie, ECMA section)
			var VERSION:* = "AS3";                   // Version of JavaScript or ECMA
			var TITLE:*   = "Testing try block with multiple catch blocks, the  catch block with parameter of type Error catching the Eval error when no catch block with parameter of type EvalError is defined";  // Provide ECMA section title or a description
			var BUGNUMBER:* = "";
			...
			try { 
			    ...
			    AddTestCase( "Testing try block with throw statement", "Error: EvalError"        ,Error(thisError)+"" );
			     }
