...
package {
	public class NestedTryWithMultipleCatchInsideFourthCatchTest extends BaseTest {
			   ...
			   throw new URIError();
			       ...
			       try { 
			           throw new TypeError();
			               ...
			               AddTestCase( "Testing Nested try block with multiple catch block inside the fourth catch block of the outer try block","This is inner finally:This is Inner Type Error:TypeError","This is inner finally:"+thisError );
			            }
			   }catch(eo4:EvalError){
			       ...
			       thisError1="This is outer Error:"+eo7.toString();
			           ...
			           AddTestCase( "Testing Nested try block with multiple catch block inside the fourth catch block of the outer try block", "This is outer finally:This is outer URI Error:URIError","This is outer finally:"+ thisError1 );
			    }
