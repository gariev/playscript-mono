...
package {
	public class MultipleCatchBlocksWithNoTypeErrorCatchBlockTest extends BaseTest {
			...
			try { 
			     throw new TypeError();
			      ...
			      thisError = e6.toString();
			       ...
			       AddTestCase( "Testing try block with throw statement", "Error: TypeError"        ,Error(thisError)+""  );
			     }
