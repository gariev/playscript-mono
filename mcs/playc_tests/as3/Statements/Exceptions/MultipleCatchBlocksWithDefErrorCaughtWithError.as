...
package {
	public class MultipleCatchBlocksWithDefErrorCaughtWithErrorTest extends BaseTest {
			...
			try { 
			     throw new DefinitionError();
			      ...
			      thisError = e7.toString();
			       ...
			       AddTestCase( "Testing try block with throw statement", "Error: DefinitionError"        ,Error(thisError)+"" );
			     }
