...
package {
	public class MultipleCatchBlocksWithRefError1Test extends BaseTest {
		public static function Main():int {
			...
			AddTestCase( "Testing try block with throw statement", "This is Reference Error"        ,thisError );
			     }
