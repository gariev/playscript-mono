...
package {
	public class MultipleCatchBlocksWithRangeErrorCaughtByErrorTest extends BaseTest {
		public static function Main():int {
			...
			try { 
			    ...
			    AddTestCase( "Testing try block with throw statement", "Error: RangeError"        ,Error(thisError)+"" );
			     }
