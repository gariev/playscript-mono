...
package {
	public class MultipleCatchBlocksWithUninitialized1Test extends BaseTest {
		public static function Main():int {
			var SECTION = "Definitions";           // provide a document reference (ie, ECMA section)
			var VERSION = "AS3";                   // Version of JavaScript or ECMA
			var TITLE   = "Testing try block with multiple catch blocks, the  catch block with parameter of type UninitializedError catching the Uninitialized error ";  // Provide ECMA section title or a description
			var BUGNUMBER = "";
			...
			AddTestCase( "Testing try block with throw statement", "This is Uninitialized Error"        ,thisError );
			     }
