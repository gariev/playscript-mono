...
package {
	public class NestedTryWithMultipleCatchInsideFinallyTest extends BaseTest {
		public static function Main():int {
			var SECTION = "Definitions";           // provide a document reference (ie, ECMA section)
			var VERSION = "AS3";                   // Version of JavaScript or ECMA
			var TITLE   = "Testing nested try block with multiple catch blocks, the inner try and multiple catch blocks inside the finally block of the outer try block";  // Provide ECMA section title or a description
			var BUGNUMBER = "";
			   ...
			   throw new ReferenceError();
			      ...
			      try { 
			          throw new TypeError();
			               ...
			               AddTestCase( "Testing Nested try block with multiple catch block inside the finally block of the inner try block","This is inner finally:This is Inner Type Error:TypeError","This is inner finally:"+thisError );
			           }
			    }
