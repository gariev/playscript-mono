...
package {
	public class NestedTryWithMultipleCatchInsideTryTest extends BaseTest {
			...
			try{
			   ...
			   try { 
			       throw new TypeError();
			           ...
			           AddTestCase( "Testing Nested try block with multiple catch block inside the try block of the outer try block","This is inner finally:This is Inner Type Error:TypeError","This is inner finally:"+thisError );
			               }
