...
package {
	public class MultipleCatchBlocksWithSyntaxErrorCaughtByErrorTest extends BaseTest {
		public static function Main():int {
			...
			try { 
			    ...
			    AddTestCase( "Testing try block with throw statement", "Error: SyntaxError"        ,Error(thisError)+"" );
			     }
