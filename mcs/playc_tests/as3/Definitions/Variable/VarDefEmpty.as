...
package {
	public class VarDefEmptyTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase( "var Identififer, Identifier : TypeExpressionA, Identifier : TypeExpressionB = AssignmentExpression [2]", arr.toString(), VARDEFEMPTY.getidIdTypeExprAAssign()+"");
