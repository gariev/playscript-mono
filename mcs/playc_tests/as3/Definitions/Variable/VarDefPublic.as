...
package {
	public class VarDefPublicTest extends BaseTest {
		public static function Main():int {
			var SECTION = "Definitions";       // provide a document reference (ie, ECMA section)
			var VERSION = "Clean AS2";  // Version of JavaScript or ECMA
			var TITLE   = "Public Variable Definition";       // Provide ECMA section title or a description
			var BUGNUMBER = "";
			...
			var VARDEFEMPTY = new VarDefPublicClass();
			AddTestCase( "Public Variable Definition defined inside class", 1, 1);
