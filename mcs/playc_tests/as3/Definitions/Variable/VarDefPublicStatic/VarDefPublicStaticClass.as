...
package VarDefPublicStatic {
  ...
  public class VarDefPublicStaticClass {
    ...
    public static var id1TypeExprAssignExpr:Boolean = true, id2TypeExprAssignExpr:Boolean = false, id3TypeExprAssignExpr:Boolean = true;
    public static var id1TypeExprAssignExprB:Boolean, id2TypeExprAssignExprB:Boolean, id3TypeExprAssignExprB:Boolean = true;
    ...
    public static var idTypeExprA:Array, idTypeExprB:Boolean; 

    // var Identifier : TypeExpressionA, Identifier : TypeExpressionB = AssignmentExpression 
    public static var idTypeExprAAssign : Array = new Array(1,2,3), idTypeExprBAssign : Boolean = true;
    public static var idTypeExprAAssignB : Array, idTypeExprBAssignB : Boolean = true;
