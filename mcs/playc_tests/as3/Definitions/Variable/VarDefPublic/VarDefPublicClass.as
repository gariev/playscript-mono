...
package VarDefPublic {
  ...
  public class VarDefPublicClass {
    ...
    public var id1TypeExprAssignExpr:Boolean = true, id2TypeExprAssignExpr:Boolean = false, id3TypeExprAssignExpr:Boolean = true;
    public var id1TypeExprAssignExprB:Boolean, id2TypeExprAssignExprB:Boolean, id3TypeExprAssignExprB:Boolean = true;
    ...
    public var idTypeExprA:Array, idTypeExprB:Boolean; 

    // var Identifier : TypeExpressionA, Identifier : TypeExpressionB = AssignmentExpression 
    public var idTypeExprAAssign : Array = new Array(1,2,3), idTypeExprBAssign : Boolean = true;
    public var idTypeExprAAssignB : Array, idTypeExprBAssignB : Boolean = true;
