...
package {
	...
	public class DefClassImpInternalIntIntnameTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Default class implements the first internal interface with an interface name method", "PASSED", obj.accdeffunc());
			//Default class implements the second internal interface with an interface name method
			AddTestCase("Default class implements the second internal interface with an interface name method", "PASSED", obj.accdeffunc_s());
