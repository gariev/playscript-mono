...
package {
	...
	public class DefClassImpInternalIntTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Default class implements an internal interface with a public method", "PASSED", obj.deffunc());
