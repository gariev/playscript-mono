...
package {
	...
	public class DefClassImpPublicIntnameTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Default class implements a public interface with an interface name method", "PASSED",obj.accdeffunc());
