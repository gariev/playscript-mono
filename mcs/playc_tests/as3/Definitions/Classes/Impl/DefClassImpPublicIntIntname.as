...
package {
	...
	public class DefClassImpPublicIntIntnameTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Default class implements the second public interface with an interface name method", "PASSED", obj.accdeffunc_s());
