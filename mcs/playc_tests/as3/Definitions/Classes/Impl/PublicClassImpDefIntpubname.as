...
package {
	...
	public class PublicClassImpDefIntpubnameTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Public class implements a default interface with a public interface name method", "PASSED", obj.deffunc());
