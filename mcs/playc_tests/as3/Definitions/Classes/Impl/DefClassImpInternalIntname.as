...
package {
	...
	public class DefClassImpInternalIntnameTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Default class implements an internal interface with a public method", "PASSED", obj.accdeffunc());
