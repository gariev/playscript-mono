...
package {
	...
	public class DynamicClassImpDefIntTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Dynamic class implements a default interface with a public method", "PASSED", obj.accdeffunc());
