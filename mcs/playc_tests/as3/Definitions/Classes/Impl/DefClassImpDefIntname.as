 ...
 * ***** END LICENSE BLOCK ***** */
package {
	import DefClassImpDefIntname.*;
	public class DefClassImpDefIntnameTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Default class implements a default interface with an interface name method", "PASSED", obj.accdeffunc());
