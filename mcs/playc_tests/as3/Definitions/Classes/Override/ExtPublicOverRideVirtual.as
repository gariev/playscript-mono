...
package {
	...
	public class ExtPublicOverRideVirtualTest extends BaseTest {
		public static function Main():int {
			...
			var CLASSDEFN:* = new ExtPublicOverRideVirtual();
			...
			AddTestCase( "CLASSDEFN.getSetVirtualBoolean( booleanValue )", booleanValue, CLASSDEFN.getSetVirtualBoolean( booleanValue ) );
