...
package {
	...
	public class ExtPublicOverRidePublicTest extends BaseTest {
		public static function Main():int {
			var SECTION:* = "Definitions";       							// provide a document reference (ie, ECMA section)
			var VERSION:* = "AS 3.0";  								// Version of JavaScript or ECMA
			var TITLE:*   = "Override public function in default class extending public class";    	// Provide ECMA section title or a description
			var BUGNUMBER:* = "";
			
			startTest();                							// leave this alone
			
			
			var CLASSDEFN:* = new ExtPublicOverRidePublic();
