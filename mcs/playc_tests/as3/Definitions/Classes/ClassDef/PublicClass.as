...
VERSION = "AS3";                   // Version of JavaScript or ECMA
TITLE   = "Access Class Properties & Methods";  // Provide ECMA section title or a description
BUGNUMBER = "";
...
AddTestCase( "Obj.setPubBoolean(b), Obj.getPubBoolean()", true, Obj.getPubBoolean() );
...
AddTestCase( "Obj.setPubVirtualBoolean(b), Obj.getPubVirtualBoolean()", false, Obj.getPubBoolean() );
...
AddTestCase( "PublicClass.setPubStatObject(ob), PublicClass.getPubStatObject()", ob, PublicClass.getPubStatObject() );
...
AddTestCase( "Obj.setPubFinArray(arr), Obj.getPubFinArray()", arr, Obj.getPubFinArray() );
...
Obj.pubBoolean = true;
AddTestCase( "Obj.pubBoolean = true, Obj.pubBoolean", true, Obj.pubBoolean );
...
AddTestCase( "PublicClass.pubStatObject = ob, PublicClass.pubStatObject", ob, PublicClass.pubStatObject );
...
Obj.pubFinArray = arr;
AddTestCase( "Obj.pubFinArray = arr, Obj.pubFinArray", arr, Obj.pubFinArray );
...
AddTestCase( "PublicClass.pubFinalStaticNumber = 10, PublicClass.pubFinalStaticNumber", 10, PublicClass.pubFinalStaticNumber );
