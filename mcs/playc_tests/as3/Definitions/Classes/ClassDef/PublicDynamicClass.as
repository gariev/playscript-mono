...
package {
	import PublicDynamicClassPackage.*;
	...
	public class PublicDynamicClassTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase( "PublicDynamicClass.setPubStatObject(ob), PublicDynamicClass.getPubStatObject()", ob, (PublicDynamicClass.setPubStatObject(ob), PublicDynamicClass.getPubStatObject()) );
			...
			AddTestCase( "PublicDynamicClass.pubStatObject = ob, PublicDynamicClass.pubStatObject", ob, (PublicDynamicClass.pubStatObject = ob, PublicDynamicClass.pubStatObject) );
			...
			AddTestCase( "PublicDynamicClass.pubFinalStaticNumber = 10, PublicDynamicClass.pubFinalStaticNumber", 10, (PublicDynamicClass.pubFinalStaticNumber = 10, PublicDynamicClass.pubFinalStaticNumber) );
