...
package {
	...
	public class FinalPublicDynamicClassMethodAndPropTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase( "AccFinPubDynClassMAndP.setPubStatObject(ob), AccFinPubDynClassMAndP.getPubStatObject()", ob,
			...
			AddTestCase( "AccFinPubDynClassMAndP.pubStatObject = ob, AccFinPubDynClassMAndP.pubStatObject", ob, (AccFinPubDynClassMAndP.pubStatObject = ob, AccFinPubDynClassMAndP.pubStatObject) );
