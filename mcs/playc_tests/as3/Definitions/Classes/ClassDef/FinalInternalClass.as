...
package {
	...
	public class FinalInternalClassTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase( "new FinalInternalClass(), FinalInternalClass.constructorCount", 2, Obj.testConstructorOne() );
			AddTestCase( "*** No param constructor test ***", 1, 1 );
			AddTestCase( "new FinalInternalClass, FinalInternalClass.constructorCount", 3, Obj.testConstructorOne() );
