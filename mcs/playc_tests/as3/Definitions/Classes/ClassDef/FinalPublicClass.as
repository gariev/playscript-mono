...
package {
	import FinalPublicClassPackage.*;
	
	public class FinalPublicClassTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase( "FinalPublicClass.setPubStatObject(ob), FinalPublicClass.getPubStatObject()", ob, (FinalPublicClass.setPubStatObject(ob), FinalPublicClass.getPubStatObject()) );
			...
			AddTestCase( "FinalPublicClass.pubStatObject = ob, FinalPublicClass.pubStatObject", ob, (FinalPublicClass.pubStatObject = ob, FinalPublicClass.pubStatObject) );
			...
			AddTestCase( "FinalPublicClass.pubFinalStaticNumber = 10, FinalPublicClass.pubFinalStaticNumber", 10, (FinalPublicClass.pubFinalStaticNumber = 10, FinalPublicClass.pubFinalStaticNumber) );
