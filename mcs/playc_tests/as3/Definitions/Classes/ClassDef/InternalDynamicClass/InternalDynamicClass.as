 ...
 *
 * ***** END LICENSE BLOCK ***** */
package InternalDynamicClassPackage {
	...
	public class InternalDynamicClassAccessor {
		private var Obj:InternalDynamicClass = new InternalDynamicClass();
		...
		public function testGetSetStatFunction(f:Function) : Function {
			InternalDynamicClass.setStatFunction(f);
			return InternalDynamicClass.getStatFunction();
		}
		...
		public function testGetSetInternalStatFunction(f:Function) : Function {
			InternalDynamicClass.setInternalStatFunction(f);
			return InternalDynamicClass.getInternalStatFunction();
		}
		...
		// Public Static methods
		public function setPubStatObject(o:Object):* { InternalDynamicClass.setPubStatObject(o); }
		public function getPubStatObject() : Object { return InternalDynamicClass.getPubStatObject(); }
		// Public Final methods
