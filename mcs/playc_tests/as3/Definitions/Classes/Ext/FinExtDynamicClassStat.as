 ...
 *  import Definitions.Classes.Ext.FinExtDynamicClassStat;
 */
package {
	import DynamicClass.*;
	
	
	public class FinExtDynamicClassStatTest extends BaseTest {
		public static function Main():int {
			var SECTION = "Definitions\Ext";       			// provide a document reference (ie, ECMA section)
			var VERSION = "AS 3.0"; 				// Version of JavaScript or ECMA
			var TITLE   = "Final Class Extends Dynamic Class Static Methods";      // Provide ECMA section title or a description
			var BUGNUMBER = "";
			...
			// access static method of parent class from outside of class
			AddTestCase( "*** Access static method of parent class from outside of class ***", 1, 1 );
			// AddTestCase( "setStatArray(arr), getStatArray()", arr, ( setStatArray( arr ), getStatArray() ) );
			
			
			// access static method from a default method of a sub class
			...
			// access static method from a dynamic method of a sub class
			...
			// access static method from a public method of a sub class
			...
			// access static method from a private method of a sub class
			...
			// access static method from a static method of a sub class
			...
			// access static method from a final method of a sub class
			...
			// access static method from a virtual method of a sub class
			...
			// access static method from a public dynamic method of a sub class
			...
			// access static method from a public static method of a sub class
			...
			// access static method from a public final method of a sub class
			...
			// access static method from a public virtual method of a sub class
			...
			// access static method from a final private method of a sub class
			...
			// access static method from a final static method of a sub class
			...
			// access static method from a private virtual method of a sub class
			...
			// access static property from outside the class
			AddTestCase( "*** Access default property from outside the class ***", 1, 1 );
			AddTestCase( "array = arr", arr, (array = arr, array) );
			
			
			// access static property from a default method of a sub class
			...
			// access static property from a dynamic method of a sub class
			...
			// access static property from a private method of a sub class
			...
			// access static property from a final method of a sub class
			...
			// access static property from a private virtual method of a sub class
			...
			// access static property from a public static method of a sub class
			...
			// access static property from a private static method of a sub class
