 ...
 *  import Definitions.Classes.Ext.FinExtInternalClass;
 */
package {
	import InternalClass.*;
	
	
	public class FinExtInternalClassTest extends BaseTest {
		public static function Main():int {
			var SECTION = "Definitions\Ext";       					// provide a document reference (ie, ECMA section)
			var VERSION = "AS 3.0";  						// Version of JavaScript or ECMA
			var TITLE   = "Final Class Extends Default Class Default Methods";      // Provide ECMA section title or a description
			var BUGNUMBER = "";
			...
			// var EXTDCLASS = new FinExtInternalClassPub();
