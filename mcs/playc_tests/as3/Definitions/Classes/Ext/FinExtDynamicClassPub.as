 ...
 *  import Definitions.Classes.Ext.FinExtDynamicClassPub;
 */
package {
	import DynamicClass.*;
	
	
	public class FinExtDynamicClassPubTest extends BaseTest {
		public static function Main():int {
			var SECTION:* = "Definitions\Ext";       				// provide a document reference (ie, ECMA section)
			var VERSION:* = "AS 3.0";  					// Version of JavaScript or ECMA
			var TITLE:*   = "Final Class Extends Dynamic Class Public Methods";       	// Provide ECMA section title or a description
			var BUGNUMBER:* = "";
			...
			// access public method of parent class from outside of class
			AddTestCase( "*** Access public method of parent class from outside of class ***", 1, 1 );
			// AddTestCase( "setPubArray(arr), pubArray", arr, ( setPubArray( arr ), pubArray() ) );
			
			
			// access public method from a default method of a sub class
			...
			// access public method from a dynamic method of a sub class
			...
			// access public method from a public method of a sub class
			...
			// access public method from a private method of a sub class
			...
			// access public method from a static method of a sub class
			...
			// access public method from a final method of a sub class
			...
			// access public method from a virtual method of a sub class
			...
			// access public method from a public dynamic method of a sub class
			...
			// access public method from a public static method of a sub class
			...
			// access public method from a public final method of a sub class
			...
			// access public method from a public virtual method of a sub class
			...
			// access public method from a final private method of a sub class
			...
			// access public method from a final static method of a sub class
			...
			// access public method from a private static method of a sub class
			...
			// access public method from a private virtual method of a sub class
			...
			// access public property from a default method of a sub class
			...
			// access public property from a dynamic method of a sub class
			...
			// access public property from a private method of a sub class
			...
			// access public property from a final method of a sub class
			...
			// access public property from a private virtual method of a sub class
			...
			// access public property from a public static method of a sub class
			...
			// access public property from a private static method of a sub class
