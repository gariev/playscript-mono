...
package {
	...
	public class IntExtPublicClassTest extends BaseTest {
		public static function Main():int {
			...
			EXTDCLASS = new IntExtPublicClass();
			...
			try{
				IntExtPublicClass.pubStatSubGetArray();
			} catch (e1) {
			...
			try{
				IntExtPublicClass.pubStatSubGetDPArray();
			} catch(e3) {
