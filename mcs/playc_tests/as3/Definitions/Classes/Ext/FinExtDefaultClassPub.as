 ...
 *  import Definitions.Classes.Ext.FinExtDefaultClassPub;
 */
package {
	import DefaultClass.*;
	
	
	public class FinExtDefaultClassPubTest extends BaseTest {
		public static function Main():int {
			var SECTION:* = "Definitions\Ext";       				// provide a document reference (ie, ECMA section)
			var VERSION:* = "AS 3.0";  					// Version of JavaScript or ECMA
			var TITLE:*   = "Final Class Extends Default Class Public Methods";       	// Provide ECMA section title or a description
			var BUGNUMBER:* = "";
			...
			AddTestCase( "pubArray = arr", arr, (pubArray = arr, pubArray) );
