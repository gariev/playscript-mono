...
package DynamicClass {
  ...
  // change the name of the class to ExtDynamicClassTest
  // we'll create a public class ExtDynamicClass that 
  // extends it for testing runtime
  internal class IntExtDynamicClassTest extends DynamicClass {
  ...
  public class IntExtDynamicClass extends IntExtDynamicClassTest {}
