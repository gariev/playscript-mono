 ...
 *  import Definitions.Classes.Ext.FinExtPublicClassStat;
 */
package {
	import PublicClass.*;
	
	
	public class FinExtPublicClassStatTest extends BaseTest {
		public static function Main():int {
			var SECTION:* = "Definitions\Ext";       			// provide a document reference (ie, ECMA section)
			var VERSION:* = "AS 3.0";  				// Version of JavaScript or ECMA
			var TITLE:*   = "Final Class Extends Public Class Static Methods";     	// Provide ECMA section title or a description
			var BUGNUMBER:* = "";
