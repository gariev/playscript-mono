...
package PublicClass {
  ...
  // change the name of the class to ExtPublicClassTest
  // we'll create a public class ExtPublicClass that 
  // extends it for testing runtime
  internal class IntExtPublicClassTest extends PublicClass {
  ...
  public class IntExtPublicClass extends IntExtPublicClassTest {}
