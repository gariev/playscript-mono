 ...
 *  import Definitions.Classes.Ext.FinExtDynamicClassFin;
 */
package {
	import DynamicClass.*;
	
	
	public class FinExtDynamicClassFinTest extends BaseTest {
		public static function Main():int {
			var SECTION:* = "Definitions\Ext";       			// provide a document reference (ie, ECMA section)
			var VERSION:* = "AS 3.0";  				// Version of JavaScript or ECMA
			var TITLE:*   = "Final Class Extends Dynamic Class Final Methods";      // Provide ECMA section title or a description
			var BUGNUMBER:* = "";
			...
			//  access final method from outside of class
			AddTestCase( "*** Access final method from outside of the class ***", 1, 1 );
			// AddTestCase( "finSetArray(arr), finSetArray()", arr, ( finSetArray( arr ), finSetArray() ) );
