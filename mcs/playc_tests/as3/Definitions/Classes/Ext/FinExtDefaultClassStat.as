 ...
 *  import Definitions.Classes.Ext.FinExtDefaultClassStat;
 */
package {
	import DefaultClass.*;
	...
	public class FinExtDefaultClassStatTest extends BaseTest {
		public static function Main():int {
			var SECTION = "Definitions\Ext";       			// provide a document reference (ie, ECMA section)
			var VERSION = "AS 3.0";  				// Version of JavaScript or ECMA
			var TITLE   = "Final Class Extends Default Class Static Methods";     	// Provide ECMA section title or a description
			var BUGNUMBER = "";
			...
			AddTestCase( "*** Cannot Access a private static method, giving: Call attempted on an object that is not a function. ***", 1, 1 );
