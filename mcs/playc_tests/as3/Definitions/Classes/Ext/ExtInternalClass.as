...
package {
	...
	public class ExtInternalClassTest extends BaseTest {
		public static function Main():int {
			...
			EXTDCLASS = new ExtInternalClass();
			...
			try{
				ExtInternalClass.pubStatSubGetArray();
			} catch (e1:*) {
			...
			try{
				ExtInternalClass.pubStatSubGetDPArray();
			} catch(e3) {
