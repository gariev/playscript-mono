...
package {
	public class FinExtPublicImplDefDefPubTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase( "iiGetNumber1", 5 , obj.acciiGetNumber1() );
			AddTestCase( "jiGetNumber1", 5 , obj.accjiGetNumber1() );
			//*******************************************
