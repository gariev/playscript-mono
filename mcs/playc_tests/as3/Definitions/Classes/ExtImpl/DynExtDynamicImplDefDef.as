...
package {
	public class DynExtDynamicImplDefDefTest extends BaseTest {
		public static function Main():int {
			...
			// *******************************************
			/*AddTestCase( "THISTEST.setBoolean(false), THISTEST.iGetBoolean()", true, (THISTEST.iGetBooleanacc1()) );
			...
			AddTestCase( "THISTEST.setNumber(420), THISTEST.iGetNumber()", 420,(THISTEST.iGetNumberacc2()) );*/
			...
			AddTestCase( "THISTEST.testPubGetSetNumber(14)", 14, THISTEST.testPubGetSetNumber(14) );
