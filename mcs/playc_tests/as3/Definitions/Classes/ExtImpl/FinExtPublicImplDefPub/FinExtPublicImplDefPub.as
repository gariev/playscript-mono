...
final class FinExtPublicImplDefPub extends PublicClass implements DefaultIntDef {
    ...
    public function testPrivSubArray(a:Array) : Array {
 	...
 	// Create an instance of the final class in the package.
  	...
  	var FINEXTDCLASS:* = new FinExtPublicImplDefPub();
...
public class accFinExtPublicImplDefPub{
	private var obj:FinExtPublicImplDefPub = new FinExtPublicImplDefPub();
