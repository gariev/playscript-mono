...
package {
	public class PubExtDefaultImplDefPubTest extends BaseTest {
		public static function Main():int {
			...
			var PUBEXTDEFIMPLDEFPUB = new PubExtDefaultImplDefPub();
			...
			AddTestCase( "PUBEXTDEFIMPLDEFPUB.setPubBoolean(false), PUBEXTDEFIMPLDEFPUB.iGetPubBoolean()", false, (PUBEXTDEFIMPLDEFPUB.setPubBoolean(false), PUBEXTDEFIMPLDEFPUB.iGetPubBoolean()) );
			AddTestCase( "PUBEXTDEFIMPLDEFPUB.setPubBoolean(true), PUBEXTDEFIMPLDEFPUB.iGetPubBoolean()", true, (PUBEXTDEFIMPLDEFPUB.setPubBoolean(true), PUBEXTDEFIMPLDEFPUB.iGetPubBoolean()) );
			...
			//*******************************************
			var EXTDCLASS = new PubExtDefaultImplDefPub();
			...
			EXTDCLASS = new PubExtDefaultImplDefPub();
