...
package {
	import PubClassExtIntClassImpPubIntExtPubPub.*;
	public class PubClassExtIntClassImpPubIntExtPubPubTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Calling a method in public namespace in the public interface implemented  by the subclass through the subclass","Good Morning!", PubInt.MyString());
			...
			AddTestCase("Calling a method in public namespace in the public interface implemented  by the subclass through the subclass","Good Morning!", obj.MyString());
			...
			AddTestCase("Calling a method in public namespace in the public interface implemented  by the subclass through the subclass","Good Morning!", obj.PublicInt2::MyString());
