...
package {
	public class FinExtDefaultImplDefDefPubTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase( "iGetBoolean", false, obj.acciiGetBoolean() );
			AddTestCase( "iGetBoolean", false, obj.accjiGetBoolean() );
			AddTestCase( "*** public method implemented interface ***", 2, 2 );
			AddTestCase( "iGetPubNumber", 5 , obj.acciGetPubNumber() );
			AddTestCase( "iGetNumber", 5 , obj.acciiGetNumber() );
			AddTestCase( "iGetNumber", 5 , obj.accjiGetNumber() );
			//*******************************************
