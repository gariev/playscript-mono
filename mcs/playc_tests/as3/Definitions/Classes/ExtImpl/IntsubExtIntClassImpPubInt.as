...
package {
	...
	public class IntsubExtIntClassImpPubIntTest extends BaseTest {
		public static function Main():int {
			...
			//AddTestCase("Internal class implements a public interface with a default method", //"PASSED", obj.accdeffunc());
			
			//Internal sub class extends Internal class that implements a public interface with a public //method
			AddTestCase("Internal sub class extends Internal class that implements a public interface with a public method", true, obj.pubFunc());
			
			//Internal sub class extends Internal class that implements a public interface with a //namespace method
			AddTestCase("Internal class extends Internal class that implements a public interface with a namespace method", 4, obj.accnsFunc());
