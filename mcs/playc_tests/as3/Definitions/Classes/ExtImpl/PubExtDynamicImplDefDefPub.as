...
package {
	public class PubExtDynamicImplDefDefPubTest extends BaseTest {
		public static function Main():int {
			...
			var PUBEXTDYNIMPLDEFDEFPUB:* = new PubExtDynamicImplDefDefPub();
			...
			var EXTDCLASS:* = new PubExtDynamicImplDefDefPub();
			...
			EXTDCLASS = new PubExtDynamicImplDefDefPub();
