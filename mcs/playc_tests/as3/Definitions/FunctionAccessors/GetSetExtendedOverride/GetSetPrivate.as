...
package GetSetExtendedOverride {
	...
	internal class GetSetPrivateInternal {
        ...
        // child class override all the parent classes getters and setters
	public class GetSetPrivate extends GetSetPrivateInternal{
		override public function get x():Array{
			return new Array(7,8,9);
		}
		override public function set y(i:int){
			// need to call parent setter because _y is private
			super.y=-99;
		}

		// call a parent getter from a child getter
		public function get childX(){
			return super.x; // calles parent getter for x
		}

		// call a parent setter from a child getter
		public function get childY():int{
			super.y = 1976;
			return super.y;
		}
		...
		public function get childW() { return _w; }
	}
