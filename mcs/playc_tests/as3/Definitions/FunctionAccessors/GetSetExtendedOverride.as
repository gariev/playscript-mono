...
package {
	import GetSetExtendedOverride.*;
	
	public class GetSetExtendedOverrideTest extends BaseTest {
		public static function Main():int {
			...
			AddTestCase("Set private var:int", -99, (OBJ.y = 23334, OBJ.y));
			AddTestCase("Get private var:Array", "7,8,9", OBJ.x.toString());
			AddTestCase("Set private var:Array", "7,8,9", (OBJ.x = new Array(4,5,6), OBJ.x.toString()));
			...
			// call a parent getter from a child getter
			AddTestCase("Call a parent getter from a child getter with super", "4,5,6", OBJ.childX.toString());
			
			// call a parent setter from a child getter
			AddTestCase("Call a parent setter from a child getter with super", 1976, OBJ.childY);
			
			// call a parent getter from a child setter
			OBJ.childZ = "FAILED";
			AddTestCase("Call a parent getter from a child setter", "new string", OBJ.childZ);
			
			// call a parent setter from a child setter
			OBJ.childW = "PASSED";
			AddTestCase("Call a parent getter from a child getter", "PASSED", OBJ.childW);
