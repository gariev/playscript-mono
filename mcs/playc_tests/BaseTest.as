...
package {
	...
	public class BaseTest {
		...
		var	msPerDay:Number =			86400000;
		var	HoursPerDay:Number	=		24;
		var	MinutesPerHour:Number =	60;
		var	SecondsPerMinute:Number =	60;
		var	msPerSecond:Number	=		1000;
		var	msPerMinute:Number	=		60000;		//	msPerSecond	* SecondsPerMinute
		var	msPerHour:Number =			3600000;	//	msPerMinute	* MinutesPerHour
		var TZ_DIFF:Number	= getTimeZoneDiff();  // offset of tester's timezone from UTC
		var TZ_PST:Number = -8;  // offset of Pacific Standard Time from UTC
		var PST_DIFF:Number = TZ_DIFF - TZ_PST;  // offset of tester's timezone from PST
		var	TIME_1970:Number	 = 0;
		var	TIME_2000:Number	 = 946684800000;
		var	TIME_1900:Number	 = -2208988800000;
		var now:Date = new Date();
		var TZ_DIFF:Number = getTimeZoneDiff();
		var TZ_ADJUST:Number = TZ_DIFF * msPerHour;
		var UTC_29_FEB_2000:Number = TIME_2000 + 31*msPerDay + 28*msPerDay;
		var UTC_1_JAN_2005:Number = TIME_2000 + TimeInYear(2000) + TimeInYear(2001) +
