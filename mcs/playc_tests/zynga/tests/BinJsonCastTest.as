package
{
	...
	public class ObjectTest
	{
		...
		public static function testBinJsonObjectMember():void
		{
			// setup local values
			...
			var jsonStr:String = JSON.stringify(o);
			var obj:Object = BinJSON.parse(jsonStr);
		...
		public static function testBinJsonObjectIndex():void
		{
			// setup local values
			var d0:Boolean = false;
			var d1:Boolean = true;
		...
		{
			// binjson object
			testBinJsonObjectMember();
			testBinJsonObjectIndex();
		}
	}
}
