...
namespace PlayScript
{
	...
	public static class ActionCreator
	{
		...
		{
			public override void ConvertThenInvoke(string value)	{ mActionTo(PSConverter.ToInt(value)); }
		}

		class InvokerThenConverterStringToInt : InvokerThenConverter<string, int>
		{
			public override int InvokeThenConvert() { return PSConverter.ToInt(mFuncFrom()); }
		}
		...
		class ConverterStringToInt : ParamConverter<string, int>
		{
			...
			{
				return PSConverter.ToInt(value);
			}
		}

		class ConverterThenInvokerStringToUint : ConverterThenInvoker<string, uint>
		{
			public override void ConvertThenInvoke(string value) { mActionTo(PSConverter.ToUInt(value)); }
		}

		class InvokerThenConverterStringToUint : InvokerThenConverter<string, uint>
		{
			public override uint InvokeThenConvert() { return PSConverter.ToUInt(mFuncFrom()); }
		}
		...
		class ConverterStringToUint : ParamConverter<string, uint>
		{
			...
			{
				return PSConverter.ToUInt(value);
			}
		}
								...
								IConverter<int>, IConverter<uint>, IConverter<double>, IConverter<bool>, IConverter<string>, IConverter<object>, IConverter<float>
	{
		...
		{
			return PSConverter.ToString(value);
		}
		...
		{
			return PSConverter.ToFloat(value);
		}
	}
